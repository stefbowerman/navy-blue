        ...
        if (cart.item_count > 0) {
          ...
          $el.slideUp({
            ...
            start: function start() {
              return $el.addClass(classes.itemRemove);
            },
...
},{"../core/cartAPI":12,"jquery":36}],2:[function(require,module,exports){
"use strict";
...
var _productDetailForm = _interopRequireDefault(require("./productDetailForm"));

var _productZoom = _interopRequireDefault(require("./productZoom"));
...
var ProductCard = /*#__PURE__*/function () {
  function ProductCard(el) {
    ...
    this.$el = (0, _jquery.default)(el);
    this.$gallery = (0, _jquery.default)(selectors.gallery, this.$el);
    this.$galleryImages = (0, _jquery.default)(selectors.galleryImage, this.$el);
    this.$productZoom = (0, _jquery.default)(selectors.productZoom, this.$el);
    this.productZoom = new _productZoom.default(this.$productZoom);
    this.productDetailForm = new _productDetailForm.default((0, _jquery.default)('[data-product-detail-form]', this.$el).first(), {
      enableHistoryState: false
    });
    this.$galleryImages.on('click', this.onGalleryImageClick.bind(this)); // Animate in...

    if (this.$gallery.length) {
      (0, _imagesloaded.default)(this.$el.get(0), function () {
        _this.$el.addClass(classes.ready);
      });
    } else {
  ...
  _createClass(ProductCard, [{
    key: "onGalleryImageClick",
    value: function onGalleryImageClick(e) {
      this.productZoom.show();
      this.productZoom.goToImage((0, _jquery.default)(e.currentTarget).index());
    }
  }]);
...
},{"./productDetailForm":3,"./productZoom":5,"imagesloaded":35,"jquery":36}],3:[function(require,module,exports){
"use strict";
...
var ProductDetailForm = /*#__PURE__*/function () {
  ...
  function ProductDetailForm(el, options) {
    ...
    this.$addToCartBtn = (0, _jquery.default)(selectors.addToCartBtn, this.$el);
    this.$addToCartBtnText = (0, _jquery.default)(selectors.addToCartText, this.$el); // Text inside the add to cart button
...
},{"../../core/ajaxFormManager":8,"./productDetailPrice":4,"./variants":6,"jquery":36}],4:[function(require,module,exports){
"use strict";
...
var ProductZoom = /*#__PURE__*/function () {
  function ProductZoom(el) {
    ...
    var effect = (0, _utils.isTouch)() && mobileSettings ? 'slide' : 'fade';
    var speed = 700;
    var loop = this.$slides.length > 1;
    this.swiper = new _swiper.default(this.$slideshow.get(0), {
      loop: loop,
      speed: speed,
      effect: effect,
      simulateTouch: false,
...
},{"../../core/utils":16,"jquery":36}],7:[function(require,module,exports){
"use strict";
...
},{"./cartAPI":12,"./utils":16,"jquery":36}],9:[function(require,module,exports){
"use strict";
...
var AppController = /*#__PURE__*/function () {
  ...
  _createClass(AppController, [{
    ...
    value: function doViewChange(AJAXResponse, ViewConstructor, type, url) {
      ...
      }, 32); // I don't know what's going on
...
},{"../views/base":26,"./utils":16,"jquery":36,"navigo":39}],11:[function(require,module,exports){
"use strict";
...
},{"jquery":36,"throttle-debounce":132}],12:[function(require,module,exports){
"use strict";
...
var formatCart = function formatCart(cart) {
  ...
  cart.total_price = (0, _currency.stripZeroCents)((0, _currency.formatMoney)(cart.total_price));
  cart.items.map(function (item) {
    item.image = (0, _image.getSizedImageUrl)(item.image, '500x');
    item.price = (0, _currency.stripZeroCents)((0, _currency.formatMoney)(item.price));
...
},{"./currency":13,"./image":14,"jquery":36}],13:[function(require,module,exports){
"use strict";
...
},{"../sections/base":18,"jquery":36}],16:[function(require,module,exports){
"use strict";
...
},{"../components/ajaxCart":1,"../core/ajaxFormManager":8,"../core/cartAPI":12,"./base":18,"jquery":36}],18:[function(require,module,exports){
"use strict";
...
},{"jquery":36}],19:[function(require,module,exports){
"use strict";
...
},{"../components/product/productCard":2,"./base":18,"jquery":36}],20:[function(require,module,exports){
"use strict";
...
var FeaturedCollectionSection = /*#__PURE__*/function (_BaseSection) {
  _inherits(FeaturedCollectionSection, _BaseSection);

  var _super = _createSuper(FeaturedCollectionSection);
  ...
  function FeaturedCollectionSection(container) {
    ...
    _this = _super.call(this, container, 'featured-collection');

    _this.$container.find(selectors.productCard).each(function (i, el) {
      return new _productCard.default(el);
    });
...
exports.default = FeaturedCollectionSection;

},{"../components/product/productCard":2,"./base":18,"jquery":36}],21:[function(require,module,exports){
"use strict";
...
var VideoEmbed = /*#__PURE__*/function () {
  function VideoEmbed(el) {
    ...
    this.$el = (0, _jquery.default)(el);
    this.$cover = (0, _jquery.default)(selectors.embedCover, this.$el);
    ...
    (0, _imagesloaded.default)(this.$cover.get(0), function () {
      _this.$cover.addClass(classes.coverImageLoaded);
    });
  ...
  _createClass(VideoEmbed, [{
    ...
    value: function onCoverClick() {
      ...
      this.player.playVideo().then(function () {
        _this2.$cover.addClass(classes.coverHidden);
      });
    }
  }, {
    key: "onPlayerStateChange",
    value: function onPlayerStateChange(_ref) {
      var data = _ref.data;
...
var PageVideosSection = /*#__PURE__*/function (_BaseSection) {
  _inherits(PageVideosSection, _BaseSection);

  var _super = _createSuper(PageVideosSection);

  function PageVideosSection(container) {
    var _this3;

    _classCallCheck(this, PageVideosSection);

    _this3 = _super.call(this, container, 'page-videos');
    _this3.embeds = _jquery.default.map((0, _jquery.default)(selectors.embed, _this3.$container), function (el) {
      return new VideoEmbed(el);
    });
    return _this3;
  }

  return PageVideosSection;
}(_base.default);

exports.default = PageVideosSection;

},{"./base":18,"imagesloaded":35,"jquery":36,"youtube-player":138}],23:[function(require,module,exports){
"use strict";
...
var ProductSection = /*#__PURE__*/function (_BaseSection) {
  ...
  function ProductSection(container) {
    ...
    _this.productCard = new _productCard.default((0, _jquery.default)(selectors.productCard, _this.$container).first());
    return _this;
  }
...
},{"../components/product/productCard":2,"./base":18,"jquery":36}],24:[function(require,module,exports){
"use strict";
...
var SiteBackgroundSection = /*#__PURE__*/function (_BaseSection) {
  _inherits(SiteBackgroundSection, _BaseSection);

  var _super = _createSuper(SiteBackgroundSection);

  function SiteBackgroundSection(container) {
    var _this;
...
var _siteBackground = _interopRequireDefault(require("./sections/siteBackground"));
...
(function () {
  ...
  sectionManager.register('site-background', _siteBackground.default);
  var header = sectionManager.getSingleInstance('header');
  var ajaxCart = sectionManager.getSingleInstance('ajax-cart');
  var appController = new _appController.default({
    ...
    onInitialViewReady: function onInitialViewReady(view) {// console.log('onInitialViewReady')
    },
    ...
    onViewChangeComplete: function onViewChangeComplete(newView) {// console.log('onViewChangeComplete')
    },
...
},{"./core/a11y":7,"./core/animations":9,"./core/appController":10,"./core/sectionManager":15,"./core/utils":16,"./sections/ajaxCart":17,"./sections/header":21,"./sections/siteBackground":24,"./views/collection":27,"./views/index":28,"./views/page":29,"./views/product":30,"jquery":36,"throttle-debounce":132}],26:[function(require,module,exports){
"use strict";
...
},{"../core/sectionManager":15}],27:[function(require,module,exports){
"use strict";
...
},{"../sections/collection":19,"./base":26}],28:[function(require,module,exports){
"use strict";
...
var _featuredCollection = _interopRequireDefault(require("../sections/featuredCollection"));
...
var IndexView = /*#__PURE__*/function (_BaseView) {
  ...
  function IndexView($el, type) {
    ...
    _this.sectionManager.register('featured-collection', _featuredCollection.default);
...
},{"../sections/featuredCollection":20,"./base":26}],29:[function(require,module,exports){
"use strict";
...
var _pageVideos = _interopRequireDefault(require("../sections/pageVideos"));
...
var PageView = /*#__PURE__*/function (_BaseView) {
  ...
  function PageView($el, type) {
    ...
    _this.sectionManager.register('page-videos', _pageVideos.default);
...
},{"../sections/pageVideos":22,"./base":26}],30:[function(require,module,exports){
"use strict";
...
},{"../sections/product":23,"./base":26}],31:[function(require,module,exports){
...
},{"./debug":32,"_process":40}],32:[function(require,module,exports){
...
},{"ssr-window":42}],34:[function(require,module,exports){
/**
 * EvEmitter v1.1.0
 * Lil' event emitter
 * MIT License
...
},{"ev-emitter":34}],36:[function(require,module,exports){
/*!
...
},{"../../utils/dom":126,"../../utils/utils":130}],44:[function(require,module,exports){
"use strict";
...
exports.default = _default;
},{"../../utils/utils":130,"ssr-window":42}],45:[function(require,module,exports){
"use strict";
...
exports.default = _default;
},{"../../utils/utils":130}],46:[function(require,module,exports){
"use strict";
...
},{"ssr-window":42}],47:[function(require,module,exports){
"use strict";
...
exports.default = _default;
},{"./getBreakpoint":46,"./setBreakpoint":48}],48:[function(require,module,exports){
"use strict";
...
},{"../../../utils/utils":130}],49:[function(require,module,exports){
"use strict";
...
exports.default = _default;
},{"./addClasses":50,"./removeClasses":52}],52:[function(require,module,exports){
"use strict";
...
exports.default = _default;
},{"./onClick":57,"./onResize":58,"./onScroll":59,"./onTouchEnd":60,"./onTouchMove":61,"./onTouchStart":62,"ssr-window":42}],57:[function(require,module,exports){
"use strict";
...
},{"../../../utils/utils":130}],61:[function(require,module,exports){
"use strict";
...
},{"../../../utils/dom":126,"../../../utils/utils":130,"ssr-window":42}],62:[function(require,module,exports){
"use strict";
...
},{"../../../utils/dom":126,"../../../utils/utils":130,"ssr-window":42}],63:[function(require,module,exports){
"use strict";
...
exports.default = _default;
},{"./setGrabCursor":64,"./unsetGrabCursor":65}],64:[function(require,module,exports){
"use strict";
...
exports.default = _default;
},{"./loadImage":67,"./preloadImages":68}],67:[function(require,module,exports){
"use strict";
...
},{"../../../utils/dom":126,"ssr-window":42}],68:[function(require,module,exports){
"use strict";
...
exports.default = _default;
},{"./loopCreate":70,"./loopDestroy":71,"./loopFix":72}],70:[function(require,module,exports){
"use strict";
...
},{"../../../utils/dom":126,"ssr-window":42}],71:[function(require,module,exports){
"use strict";
...
exports.default = _default;
},{"./addSlide":73,"./appendSlide":74,"./prependSlide":76,"./removeAllSlides":77,"./removeSlide":78}],76:[function(require,module,exports){
"use strict";
...
exports.default = _default;
},{"../../utils/utils":130}],80:[function(require,module,exports){
"use strict";
...
exports.default = _default;
},{"./slideNext":81,"./slidePrev":82,"./slideReset":83,"./slideTo":84,"./slideToClickedSlide":85,"./slideToClosest":86,"./slideToLoop":87}],81:[function(require,module,exports){
"use strict";
...
},{"../../../utils/dom":126,"../../../utils/utils":130}],86:[function(require,module,exports){
"use strict";
...
exports.default = _default;
},{"./setTransition":89,"./transitionEnd":90,"./transitionStart":91}],89:[function(require,module,exports){
"use strict";
...
},{"../../../utils/utils":130}],93:[function(require,module,exports){
"use strict";
...
exports.default = _default;
},{"./getTranslate":92,"./maxTranslate":94,"./minTranslate":95,"./setTranslate":96,"./translateTo":97}],94:[function(require,module,exports){
"use strict";
...
exports.default = _default;
},{"./updateActiveIndex":99,"./updateAutoHeight":100,"./updateClickedSlide":101,"./updateProgress":102,"./updateSize":103,"./updateSlides":104,"./updateSlidesClasses":105,"./updateSlidesOffset":106,"./updateSlidesProgress":107}],99:[function(require,module,exports){
"use strict";
...
},{"../../../utils/utils":130}],100:[function(require,module,exports){
"use strict";
...
},{"../../../utils/dom":126}],102:[function(require,module,exports){
"use strict";
...
},{"../../../utils/utils":130}],103:[function(require,module,exports){
"use strict";
...
},{"../../../utils/utils":130}],104:[function(require,module,exports){
"use strict";
...
},{"../../../utils/utils":130,"ssr-window":42}],105:[function(require,module,exports){
"use strict";
...
},{"../../../utils/dom":126}],108:[function(require,module,exports){
"use strict";
...
exports.default = _default;
},{"../../utils/dom":126,"../../utils/utils":130}],109:[function(require,module,exports){
"use strict";
...
exports.default = _default;
},{"../../utils/dom":126,"../../utils/utils":130}],110:[function(require,module,exports){
"use strict";
...
exports.default = _default;
},{"../../utils/utils":130}],111:[function(require,module,exports){
"use strict";
...
exports.default = _default;
},{"../../utils/dom":126,"../../utils/utils":130}],112:[function(require,module,exports){
"use strict";
...
exports.default = _default;
},{"../../utils/dom":126,"../../utils/utils":130,"ssr-window":42}],113:[function(require,module,exports){
"use strict";
...
exports.default = _default;
},{"../../utils/utils":130,"ssr-window":42}],114:[function(require,module,exports){
"use strict";
...
exports.default = _default;
},{"../../utils/dom":126,"../../utils/utils":130,"ssr-window":42}],115:[function(require,module,exports){
"use strict";
...
exports.default = _default;
},{"../../utils/dom":126,"../../utils/utils":130,"ssr-window":42}],116:[function(require,module,exports){
"use strict";
...
exports.default = _default;
},{"../../utils/dom":126,"../../utils/utils":130,"ssr-window":42}],117:[function(require,module,exports){
"use strict";
...
exports.default = _default;
},{"../../utils/dom":126,"../../utils/utils":130}],118:[function(require,module,exports){
"use strict";
...
exports.default = _default;
},{"../../utils/dom":126,"../../utils/utils":130}],119:[function(require,module,exports){
"use strict";
...
exports.default = _default;
},{"../../utils/dom":126,"../../utils/utils":130}],120:[function(require,module,exports){
"use strict";
...
exports.default = _default;
},{"../../utils/dom":126,"../../utils/utils":130,"ssr-window":42}],121:[function(require,module,exports){
"use strict";
...
exports.default = _default;
},{"../../utils/dom":126,"../../utils/utils":130}],122:[function(require,module,exports){
"use strict";
...
exports.default = _default;
},{"../../utils/dom":126,"../../utils/utils":130}],123:[function(require,module,exports){
"use strict";
...
exports.default = _default;
},{"../../utils/dom":126,"../../utils/utils":130,"ssr-window":42}],124:[function(require,module,exports){
"use strict";
...
exports.default = _default;
},{"../../utils/utils":130,"ssr-window":42}],125:[function(require,module,exports){
"use strict";
...
exports.default = _default;
},{"../../utils/utils":130,"ssr-window":42}],126:[function(require,module,exports){
"use strict";
...
var _default = _dom.$;
exports.default = _default;
},{"dom7":33}],127:[function(require,module,exports){
"use strict";
...
},{"ssr-window":42}],128:[function(require,module,exports){
"use strict";
...
},{"./get-support":129,"ssr-window":42}],129:[function(require,module,exports){
"use strict";
...
},{"ssr-window":42}],130:[function(require,module,exports){
"use strict";
...
},{"ssr-window":42}],131:[function(require,module,exports){
/**
 * Swiper 6.5.0
...
},{"./cjs/components/a11y/a11y":43,"./cjs/components/autoplay/autoplay":44,"./cjs/components/controller/controller":45,"./cjs/components/core/core-class":53,"./cjs/components/effect-coverflow/effect-coverflow":108,"./cjs/components/effect-cube/effect-cube":109,"./cjs/components/effect-fade/effect-fade":110,"./cjs/components/effect-flip/effect-flip":111,"./cjs/components/hash-navigation/hash-navigation":112,"./cjs/components/history/history":113,"./cjs/components/keyboard/keyboard":114,"./cjs/components/lazy/lazy":115,"./cjs/components/mousewheel/mousewheel":116,"./cjs/components/navigation/navigation":117,"./cjs/components/pagination/pagination":118,"./cjs/components/parallax/parallax":119,"./cjs/components/scrollbar/scrollbar":120,"./cjs/components/thumbs/thumbs":121,"./cjs/components/virtual/virtual":122,"./cjs/components/zoom/zoom":123}],132:[function(require,module,exports){
'use strict';
...
},{"./constants/PlayerStates":135}],134:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"./FunctionStateMap":133,"./eventNames":136,"./functionNames":137,"debug":31}],135:[function(require,module,exports){
"use strict";
...
module.exports = exports['default'];
},{"./YouTubePlayer":134,"./loadYouTubeIframeApi":139,"sister":41}],139:[function(require,module,exports){
'use strict';
